...
/**
 * Provides a list controller for the website feedback entity type.
 */
class WebsiteFeedbackListBuilder extends EntityListBuilder {
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total website feedbacks: @total', ['@total' => $total]);
    return $build;
  }
